...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    public class NonNativeKeyboardCustom : InputSystemGlobalHandlerListener, IMixedRealityDictationHandler
    {
        public static NonNativeKeyboardCustom Instance { get; private set; }
        ...
        /// </summary>
        public event Action<KeyboardValueKeyCustom> OnKeyboardValueKeyPressed = delegate { };

        /// <summary>
        /// Event fired when function key on keyboard is pressed.
        /// Fires before internal keyboard state is updated.
        /// </summary>
        public event Action<KeyboardKeyFuncCustom> OnKeyboardFunctionKeyPressed = delegate { };
        ...
        public void AppendValue(KeyboardValueKeyCustom valueKey)
        {
            IndicateActivity();
            string value = "";
        ...
        public void FunctionKey(KeyboardKeyFuncCustom functionKey)
        {
            IndicateActivity();
            OnKeyboardFunctionKeyPressed(functionKey);
            switch (functionKey.ButtonFunction)
            {
                case KeyboardKeyFuncCustom.Function.Enter:
                    {
                        Enter();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Tab:
                    {
                        Tab();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.ABC:
                    {
                        ActivateSpecificKeyboard(m_LastKeyboardLayout);
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Symbol:
                    {
                        ActivateSpecificKeyboard(LayoutType.Symbol);
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Previous:
                    {
                        MoveCaretLeft();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Next:
                    {
                        MoveCaretRight();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Close:
                    {
                        Close();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Dictate:
                    {
                ...
                case KeyboardKeyFuncCustom.Function.Shift:
                    {
                        Shift(!m_IsShifted);
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.CapsLock:
                    {
                        CapsLock(!m_IsCapslocked);
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Space:
                    {
                        Space();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.Backspace:
                    {
                        Backspace();
                        break;
                    }

                case KeyboardKeyFuncCustom.Function.UNDEFINED:
                    {
